...
\newcommand{\legend}[3] { %{Id}{Size}{Location}
  ...
  \clusterOperator{coL}{\legendSize}{below = 0.2 * \legendDis cm of LOC}{}
  \node[right = 0.25 cm of coL] (coL_label) {Cluster Operator};
  
  \topicOperator{toL}{\legendSize}{below = 1.0 * \legendDis cm of LOC}{}
  \node[right = 0.25 cm of toL] (to_label) {Topic Operator};
  
  \kafkaPod{kpL}{\legendSize}{below = 1.8 * \legendDis cm of LOC}{fill=yellow}
  \node[right = 0.25 cm of kpL] (kpL_label) {Kafka Broker Pod};
  
  \zookeeper{zL}{\legendSize}{below = 2.6 * \legendDis cm of LOC}
  \node[right = 0.25 cm of zL] (zL_label) {Zookeeper Pod};
 
  \configMap{cmL}{\legendSize}{below = 3.4 * \legendDis cm of LOC}
...
\begin{tikzpicture}
  ...
  \clusterOperator{co0}{\diagramSize}{right = 0.15cm of hw0_openshift.mid}{}
  \configMap{cm0}{\diagramSize}{left = 0.15cm of hw0_openshift.mid}
  
  \hardware{hw1}{1.0}{right = 1cm of hw0}
  \topicOperator{to0}{\diagramSize}{right = 0.15cm of hw1_openshift.mid}{}
  \configMap{cm1}{\diagramSize}{left = 0.15cm of hw1_openshift.mid}
  
  \hardware{hw2}{1.0}{above right = 4.5cm and 1cm of hw1}
  \kafkaPod{kp0}{\diagramSize}{right = 0.15cm of hw2_openshift.mid}{fill=yellow}
  \zookeeper{z0}{\diagramSize}{left = 0.15cm of hw2_openshift.mid}
  
  \hardware{hw3}{1.0}{below = 2cm of hw2}
  \kafkaPod{kp1}{\diagramSize}{right = 0.15cm of hw3_openshift.mid}{fill=yellow}
  \zookeeper{z1}{\diagramSize}{left = 0.15cm of hw3_openshift.mid}
  
  \hardware{hw4}{1.0}{below = 2cm of hw3}
  \kafkaPod{kp2}{\diagramSize}{right = 0.15cm of hw4_openshift.mid}{fill=yellow}
