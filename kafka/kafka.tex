...
\begin{tikzpicture}
  ...
  \node[above = 0.15cm of ALIGNRECTANGLE.100, anchor=center] (partition_label) {\bfseries{partition}};
  ...
  \draw [to path={-| (\tikztotarget)}]
    (seg_label) edge (b0_par0_r1.north west)
  ...
  \node[below = 0.4cm of b0_par0_r6.south, anchor=north] (new_rec_label) {\bfseries{new record}};
  ...
  \node[above left = 0.3cm and 0.2 cm of ALIGNRECTANGLE.west, anchor=east] (topic_label) {\bfseries{Topic}};
  \draw [to path={|- (\tikztotarget)}]
