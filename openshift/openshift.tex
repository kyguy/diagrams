...
\begin{document}
  ...
  \pgfmathsetmacro\hwSize{\diagramSize * 1.20}
  \pgfmathsetmacro\poSize{\diagramSize * 0.5} % pod
  \pgfmathsetmacro\ceSize{\diagramSize * 0.55} % container engine
  \pgfmathsetmacro\coSize{\poSize * 0.27} % container
  \pgfmathsetmacro\coSepSize{\coSize * 0.5} % container

  \pgfmathsetmacro\fontSize{\diagramSize * 3}
  \pgfmathsetmacro\fontSep{\diagramSize *  2}
  ...
  % Rectangle Outlines
  \pgfmathsetmacro\innerRectangleHeight{\outlineSize * 0.8}
  \pgfmathsetmacro\innerRectangleWidth{\outlineSize * 0.75}
  \pgfmathsetmacro\centerRectangleHeight{\outlineSize * 0.37}
  \pgfmathsetmacro\centerRectangleWidth{\outlineSize * 0.75}
  \pgfmathsetmacro\midRectangleHeight{\outlineSize * 1.5}
  \pgfmathsetmacro\rightRectangleHeight{\outlineSize * 0.25}
  \pgfmathsetmacro\rightRectangleWidth{\outlineSize * 0.15}
...
\begin{tikzpicture}
   ...
   \outline{o2}{}{above=0 cm of CENTERRECTANGLE.north east, anchor=center}{{
   ...
   \containerEngine{ce}{\ceSize}{above = 0.6 cm of hw0_openshift.south, anchor=center}
   ...
   \node[above= 0cm of c0.north, text=white, anchor=south, inner sep=0mm ] () {Containers};
   %\path[->, to path={-| (\tikztotarget)}]
   %  (C_LABEL_\id.west) edge (C0_\id.north)
   %  (C_LABEL_\id.east) edge (C7_\id.north);
   
   \podd{p0}{\poSize}{above = 0 cm of CENTERRECTANGLE.north, anchor=center }{}
   \node[text=white, above = 0cm of p0.north, anchor=south, inner sep =0 mm] {Pod};     
   ...
   \draw [text=white,] 
     (p0.east) -- node[above] {could be} ++ (RIGHTRECTANGLE)
   ;
   %line width=0.01 mm
