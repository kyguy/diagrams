...
\newcommand{\kafkaPod}[4]{% {Id}{Size}{Location}{label}
  ...
  \pgfmathsetmacro\kafkaPodLabelDist{\kafkaPodSize*-0.20}
  ...
  \begin{pgfonlayer}{main}
    \node[
           ...
           draw=white,
           fit=(\kafkaPodId_0),
           label={[label distance=\kafkaPodLabelDist cm]0:{\fontsize{\fontSize pt}{\fontSep pt}\selectfont #4}}
         ] (\kafkaPodId) {};
  \end{pgfonlayer}
}
...
\newcommand{\kafkaConnectPod}[4]{% {Id}{Size}{Location}{label}
  ...
  \pgfmathsetmacro\kcPodLabelDist{\kafkaConnectPodSize*-0.20}
  ...
  \begin{pgfonlayer}{main}
    \node[ circle, 
           ...
           label={[label distance=\kcPodLabelDist cm]0:{\fontsize{\fontSize pt}{\fontSep pt}\selectfont #4}}
         ] (\kafkaConnectPodId) {};
  \end{pgfonlayer}
}
...
\newcommand{\zookeeper}[4] { %{Id}{Size}{Location}{label}
  ...
  \pgfmathsetmacro\ZookeeperLabelDist{\zookeeperSize * -0.20}
...
\newcommand{\fluentd}[4] { %{Id}{Size}{Location}{label}
  ...
  \pgfmathsetmacro\fluentdLabelDist{\fluentdSize * -0.20}
  \node[ circle, 
         fluentdLocation,
         inner sep = 0 mm,
         minimum size=\fluentdSize cm,
         fill=FluentdColor!\colorIntensity,
         draw=white,
...
\newcommand{\elasticsearch}[4] { %{Id}{Size}{Location}{label}
  ...
  \node[ circle, 
         ...
         fill=ElasticsearchColor!\colorIntensity,
         draw=white,
...
\newcommand{\strimzi}[4] { %{Id}{Size}{Location}{label}
  ...
  \pgfmathsetmacro\strimziLabelDist{\strimziSize * -0.20}

  \node[ circle, 
         strimziLocation,
         inner sep = 0 mm,
         minimum size=\strimziSize cm, 
         fill=StrimziColor!\colorIntensity,
         draw=white,
